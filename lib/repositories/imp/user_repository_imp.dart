...
class UserRepositoryImp implements UserRepository {
  ...
  Future<User> loadUserInfo() async {
    ...
    ///
  Future<DAOResult> _auth(context, String code) async {
  ...
  ///
  Future<DAOResult> _logIn(context, String username, String password) async {
    Dlog.log(username);
    Dlog.log(password);
  ...
  ///
  Future<DAOResult> _getUser(String userName, {
    bool isNeedDB = false
  }) async {
    ...
    next() async {
      ...
      if (res != null && res.result) {
        ...
        if (isNeedDB) {
          userDao.addUser(userName, json.encode(user.toJson()));
        }
  ...
  ///
  Future<DAOResult> _getUserInfo() async {
